...
variable "frontend_env" {
  type        = map(string)
  default     = {}
  description = "Plain environment variables for frontend container"
}
...
variable "existing_backend_ecr_repository_url" {
  ...
  default     = "203918842750.dkr.ecr.us-east-1.amazonaws.com/colossus-knowledge-manager-backend"
}

variable "existing_frontend_ecr_repository_url" {
  type        = string
  description = "Existing frontend ECR repository URL (required)"
  default     = "203918842750.dkr.ecr.us-east-1.amazonaws.com/colossus-knowledge-manager-frontend"
}
